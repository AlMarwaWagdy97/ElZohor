...
<body>
    ...
    <!-- Begin page -->
    <div class="accountbg"
        style="background:  url('{{ @$adminLoginTheme->background != null ? asset(@$adminLoginTheme->background) : admin_path('images/cover.jpg') }}');background-size: cover;background-position: center;"></div>
                            ...
                            <div class="text-center">
                                <div class="col-md-12">
                                    <a href="{{ route('admin.login') }}">
                                        <img src="{{ @$adminLoginTheme->logo_image  != null ? asset( @$adminLoginTheme->logo_image ) : admin_path('images/logo.png') }}"
