...
@section('title_page', trans('reviews.edit', ['name' => @$review->trans->where('locale',
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.reviews.update', $review->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div id="collapseOne{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne{{ $key }}" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="{{ $locale }}[title]" value="{{ @$review->trans->where('locale', $locale)->first()->title }}" id="title{{ $key }}">
                                                        </div>
                                                    ...
                                                    <div class="row mb-3 slug-section">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" id="slug{{ $key }}" name="{{ $locale }}[slug]" value="{{ @$review->trans->where('locale', $locale)->first()->slug }}" class="form-control slug mb-3" required>
                                                        ...
                                                        {{-- type ------------------------------------------------------------------------------------- --}}
                                                        <div class="row mb-3">
                                                            <label for="example-text-input" class="col-sm-2 col-form-label">{{ trans('admin.type_in') . trans('lang.' . Locale::getDisplayName($locale)) }}</label>
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="{{ $locale }}[type]" value="{{ @$review->trans->where('locale', $locale)->first()->type }}" id="type{{ $key }}">
                                                            </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea id="description{{ $key }}" name="{{ $locale }}[description]"> {{ @$review->trans->where('locale', $locale)->first()->description }} </textarea>
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="number" placeholder="@lang('articles.sort'):" id="example-number-input" name="sort" value="{{ @$review->sort }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- feature ------------------------------------------------------------------------------------- --}}
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="feature" type="checkbox" id="switch1" switch="success" {{ @$review->feature == 1 ? 'checked' : '' }} value="1">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="status" type="checkbox" id="switch3" switch="success" {{ @$review->status == 1 ? 'checked' : '' }} value="1">
                            ...
                            <div class="row mb-3 text-end">
                                <div>
                                    <a href="{{ route('admin.reviews.index') }}" class="btn btn-outline-danger waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
