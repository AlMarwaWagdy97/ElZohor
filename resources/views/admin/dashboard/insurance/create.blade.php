...
@section('title', trans('insurance.create_insurance'))
@section('title_page', trans('insurance.create_insurance'))
                                            ...
                                            <div id="collapseOne{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne{{ $key }}" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input required class="form-control" type="text" name="{{ $locale }}[title]" value="{{ old($locale . '.title') }}" id="title{{ $key }}">
                                                        </div>
                                                    ...
                                                    <div class="row mb-3 slug-section">
                                                        ...
                                                        <div class="row mb-3 mt-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea  required  id="description{{ $key }}" name="{{ $locale }}[description]"> {{ old($locale . '.description') }} </textarea>
