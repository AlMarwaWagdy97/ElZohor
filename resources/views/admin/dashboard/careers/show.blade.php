...
@section('title', trans('admin.careers_show' , ['name' => ''] ))
@section('title_page', trans('admin.careers_show', ['name' => @$career->title]) )
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        {{-- title ------------------------------------------------------------------------------------- --}}
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text" name="{{ $locale }}[title]"  disabled value="{{ @$career->trans->where('locale',$locale)->first()->title}}" id="title{{ $key }}">
                                                                </div>
                                                        ...
                                                        {{-- slug ------------------------------------------------------------------------------------- --}}
                                                            <div class="row mb-3 slug-section">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="{{ $locale }}[slug]" disabled value="{{ @$career->trans->where('locale',$locale)->first()->slug}}" id="slug{{ $key }}"
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea id="description{{ $key }}" name="{{ $locale }}[description]" disabled> {{ @$career->trans->where('locale',$locale)->first()->description }} </textarea>
                                                        ...
                                                        @foreach ($languages as $key => $locale)
                                                            ...
                                                            {{-- meta_title_ ------------------------------------------------------------------------------------- --}}
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input class="form-control" type="text" name="{{ $locale }}[meta_title]" disabled  value="{{ @$career->trans->where('locale',$locale)->first()->meta_title}}" id="title{{ $key }}">
                                                                    </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea name="{{ $locale }}[meta_description]" class="form-control description" disabled> {{ @$career->trans->where('locale',$locale)->first()->meta_description }} </textarea>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea  name="{{ $locale }}[meta_key]" class="form-control description" disabled> {{ @$career->trans->where('locale',$locale)->first()->meta_key }} </textarea>
                                            ...
                                            <div class="accordion-item border rounded">
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            <div class="col-sm-12">
                                                                <a href="{{ asset( @$career->image) }}" target="_blank">
                                                    ...
                                                    {{-- sort ------------------------------------------------------------------------------------- --}}
                                                        <div class="col-12">
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" disabled type="number" placeholder="@lang('articles.sort'):" id="example-number-input" value="{{ @$career->sort }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    {{-- feature ------------------------------------------------------------------------------------- --}}
