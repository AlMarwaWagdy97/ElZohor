...
@section('title', trans('admin.careers_create'))
@section('title_page', trans('admin.careers_create'))
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select name="category_id" class="form-control">
                                                                        ...
                                                                        @forelse(@$categories as $category)
                                                                            ...
                                                                            <option
                                                                                {{   old('category_id') ?     'selected' : ''}}   value="{{$category->id}}"> {{ optional($category->transNow)->title  }} </option>
