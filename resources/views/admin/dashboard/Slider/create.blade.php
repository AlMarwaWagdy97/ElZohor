                                            ...
                                            <div id="collapseOne{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne{{ $key }}" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="{{ $locale }}[sub_title]" value="{{ old($locale . '.sub_title') }}" id="sub_title{{ $key }}">
                                                        </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="{{ $locale }}[sub_description]" value="{{ old($locale . '.sub_description') }}" id="sub_description{{ $key }}">
                                                        </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10 mb-2">
                                                            <textarea id="description{{ $key }}" name="{{ $locale }}[description]" class="form-control" rows="4"> {{ old($locale . '.description') }} </textarea>
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input class="form-control" type="text" id="example-number-input" name="url" value="{{ old('url') }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <label class="form-label" for="switch3" data-on-label=" @lang('admin.yes') " data-off-label=" @lang('admin.yes')"></label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
