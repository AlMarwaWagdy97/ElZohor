                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mb-3">
                                                     ...
                                                     <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="{{ $locale }}[sub_title]" value="{{ @$slider->trans->where('locale',$locale)->first()->sub_title  }}" id="sub_title{{ $key }}">
                                                        </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="{{ $locale }}[sub_description]" value="{{ @$slider->trans->where('locale',$locale)->first()->sub_description  }}" id="sub_description{{ $key }}">
                                                        </div>
                                        ...
                                        <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="status" type="checkbox" id="switch3" switch="success" {{ @$slider->status == 1 ? 'checked' : '' }} value="1">
