...
@section('title', trans('teams.create_teams'))
@section('title_page', trans('teams.create_teams'))
                                        ...
                                        <div class="accordion-item border rounded">
                                            ...
                                            <div id="collapseOne{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne{{ $key }}" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    <!-- name --->
                                                    <div class="row mb-3">
                                                        <label for="name{{ $locale }}" class="col-sm-2 col-form-label">
                                                            {{ trans('teams.name') }}
                                                            {{ trans('lang.' . Locale::getDisplayName($locale)) }}
                                                        </label>
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="{{ $locale }}[name]" value="{{ old($locale . '.name') }}" id="title{{ $key }}">
                                                        </div>
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="{{ $locale }}[job_title]" value="{{ old($locale . '.job_title') }}" id="job_title{{ $key }}">
                                                        </div>
                                                    ...
                                                    <!-----description--->
                                                    <div class="row mt-3">
                                                        <label for="example-text-input" class="col-sm-2 col-form-label">{{ trans('teams.description') . trans('lang.' . Locale::getDisplayName($locale)) }}</label>
                                                        <div class="col-sm-10 mb-2">
                                                            <textarea id="description{{ $key }}" name="{{ $locale }}[description]" class="m-auto form-control " style="margin-top: 10px"> {{ old($locale . '.description') }} </textarea>
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-12">
                                                 ...
                                                 <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="is_directors" type="checkbox" id="switch4" switch="success"  value="1">
                                                        <label class="form-label" for="switch4" data-on-label=" @lang('admin.yes')" checked data-off-label=" @lang('admin.no')"></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
