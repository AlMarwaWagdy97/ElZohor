                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        {{-- title ------------------------------------------------------------------------------------- --}}
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control" type="text" name="{{ $locale }}[title]"  disabled value="{{ $trans->title}}" id="title{{ $key }}">
                                                                </div>
                                                        ...
                                                        {{-- slug ------------------------------------------------------------------------------------- --}}
                                                            <div class="row mb-3 slug-section">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="{{ $locale }}[slug]" disabled value="{{ $trans->slug}}" id="slug{{ $key }}"
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea id="description{{ $key }}" name="{{ $locale }}[description]" disabled> {{ $trans->description }} </textarea>
                                                        ...
                                                        @foreach ($languages as $key => $locale)
                                                            ...
                                                            {{-- meta_title_ ------------------------------------------------------------------------------------- --}}
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input class="form-control" type="text" name="{{ $locale }}[meta_title]" disabled  value="{{ $trans->meta_title}}" id="title{{ $key }}">
                                                                    </div>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea name="{{ $locale }}[meta_description]" class="form-control description" disabled> {{ $trans->meta_description }} </textarea>
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-10 mb-2">
                                                                        <textarea  name="{{ $locale }}[meta_key]" class="form-control description" disabled> {{ $trans->meta_key }} </textarea>
                                                    ...
                                                    {{-- sort ------------------------------------------------------------------------------------- --}}
                                                        <div class="col-12">
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input class="form-control" disabled type="number" placeholder="@lang('articles.sort'):" id="example-number-input" value="{{ $blog->sort }}">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    {{-- feature ------------------------------------------------------------------------------------- --}}
