        ...
        <div class="row">
            <div class="col-12 m-3">
                <div class="row mb-3 text-end">
                    <div>
                        <a href="{{ route('admin.blogs.index') }}" class="btn btn-outline-primary waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
                    </div>
                </div>
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('admin.blogs.update', $blog->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div id="collapseOne{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne{{ $key }}" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="{{ $locale }}[title]" value="{{ @$blog->trans->where('locale', $locale)->first()->title }}" id="title{{ $key }}">
                                                        </div>
                                                    ...
                                                    <div class="row mb-3 slug-section">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" id="slug{{ $key }}" name="{{ $locale }}[slug]" value="{{ @$blog->trans->where('locale', $locale)->first()->slug }}" class="form-control slug mb-3" required>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea id="description{{ $key }}" name="{{ $locale }}[description]"> {{ @$blog->trans->where('locale',$locale)->first()->description }} </textarea>
                                                ...
                                                <div id="collapseTwo{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingTwo{{ $key }}" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="{{ $locale }}[meta_title]" value="{{ @$blog->trans->where('locale', $locale)->first()->meta_title }}" id="title{{ $key }}">
                                                            </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea name="{{ $locale }}[meta_description]" class="form-control description"> {{ @$blog->trans->where('locale', $locale)->first()->meta_description }} </textarea>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea name="{{ $locale }}[meta_key]" class="form-control description"> {{ @$blog->trans->where('locale', $locale)->first()->meta_key }} </textarea>
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <input class="form-control" type="number" placeholder="@lang('articles.sort'):" id="example-number-input" name="sort" value="{{ @$blog->sort }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    {{-- feature ------------------------------------------------------------------------------------- --}}
                                                    <div class="col-12">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-check form-switch" name="feature" type="checkbox" id="switch1" switch="success" {{ @$blog->feature == 1 ? 'checked' : '' }} value="1">
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-check form-switch" name="status" type="checkbox" id="switch3" switch="success" {{ @$blog->status == 1 ? 'checked' : '' }} value="1">
                            ...
                            <div class="row mb-3 text-end">
                                <div>
                                    <a href="{{ route('admin.blogs.index') }}" class="btn btn-outline-danger waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
