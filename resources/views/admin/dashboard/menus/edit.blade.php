                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input class="form-control title" type="text"
                                                                           name="{{ $locale }}[title]"
                                                                           value="{{ @$menu->trans->where('locale', $locale)->first()->title }}"
                                                                           id="title{{ $key }}">
                                                            ...
                                                            <div class="row mb-3 slug-section">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="text" name="{{ $locale }}[slug]"
                                                                           value="{{ @$menu->trans->where('locale', $locale)->first()->slug }}"
                                                ...
                                                <div class="accordion-item border rounded">
                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class=" row mb-3">
                                                                <label
                                                                    for="example-number-input"> @lang('menus.position'):
                                                                </label>
                                                                <div class="col-sm-12">
                                                                    @foreach (App\Enums\MenuPositionEnums::values() as $pos)
                                                                        <input type="radio"
                                                                               {{ $pos == @$menu->position ? 'checked' : '' }} class="position"
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select class="form-select form-select-sm select2"
                                                                        ...
                                                                        @foreach ($menus as $menuItem)
                                                                            <option
                                                                                value="{{ $menuItem->id }}" {{ $menuItem->id == $menu->parent_id ? 'selected' : '' }}>
                                                                    ...
                                                                    <div class="col-sm-12">
                                                                        <select class="form-select form-select-sm"
                                                                            ...
                                                                            @foreach (App\Enums\UrlTypesEnum::values() as $enumTypes)
                                                                                <option
                                                                                    value="{{ $enumTypes }}" {{ $enumTypes == @$menu->dynamic_table ? 'selected' : '' }}>
                                                                                    {{ $enumTypes }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                        @if ('type')
                                                                ...
                                                                <div class="col-12">
                                                                    ...
                                                                    <div class="col-sm-10">
                                                                        <input class="form-check form-switch"
                                                                               ...
                                                                               {{ $menu->status == '1' ? 'checked' : '' }} value="{{ $menu->status }}">
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#dynamic-type").on('change', function () {
                ...
                } else if (val == "all clients") {
                    $('#get-dynamic-urls').find('option').remove().end();
                    $("#get-dynamic-urls").append('<option selected value="/clients">/clients</option>');
                } else if (val == "all teams") {
                    $('#get-dynamic-urls').find('option').remove().end();
                    $("#get-dynamic-urls").append('<option selected value="/teams">/teams</option>');
                } else if (val == "all videos") {
                    $('#get-dynamic-urls').find('option').remove().end();
                    $("#get-dynamic-urls").append('<option selected value="/videos">/videos</option>');
                } else if (val == "all certifications") {
                    $('#get-dynamic-urls').find('option').remove().end();
                    $("#get-dynamic-urls").append(
                        '<option selected value="/certifications">/certifications</option>');
                }
                /*****************/
                else if (val == "all careers") {
                    $('#get-dynamic-urls').find('option').remove().end();
                    $("#get-dynamic-urls").append(
                        '<option selected value="/careers">/careers</option>');
