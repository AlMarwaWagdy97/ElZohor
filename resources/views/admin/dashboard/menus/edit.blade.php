                                                    ...
                                                    <div id="collapseOne" class="accordion-collapse collapse show"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <div class=" row mb-3">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    @foreach (App\Enums\MenuPositionEnums::values() as $pos)
                                                                        <input type="radio"
                                                                            {{ $pos == @$menu->position ? 'checked' : '' }}
                                                                            class="position" id="position" name="position"
                                                                            value="{{ $pos }}" required>
                                                                        <label
                                                            ...
                                                            <div class=" row mb-3">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <select
                                                                        class="form-select form-select-sm select2"id="parents"
                                                                        name="parent_id">
                                                                        <option value="" selected>
                                                                            {{ trans('menus.select_parent') }}</option>
                                                                        @foreach ($menus as $menuItem)
                                                                            <option value="{{ $menuItem->id }}"
                                                                                {{ $menuItem->id == $menu->parent_id ? 'selected' : '' }}>
        ...
        $(document).ready(function() {
            ...
            $("#dynamic-type").on('change', function() {
                let val = $(this).val();
                 ...
                 } else if (val == "insurance") { //insurance
                     $('#get-dynamic-urls').find('option').remove().end();
                     $("#get-dynamic-urls").append('<option selected value="/insurance">/insurance</option>');
