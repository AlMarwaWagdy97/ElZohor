...
@section('title', trans('admin.user_scripts_edit'))
@section('title_page', trans('admin.user_scripts_edit') )
                ...
                <div class="col-12 m-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.user_scripts.update_all') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                                ...
                                                <div id="collapseTwo2" class="accordion-collapse collapse show"
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-check form-switch" name="header[status]" type="checkbox"
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="col-12">
                                                            <label class="col-sm-12 col-form-label"
                                                                for="available">{{ trans('admin.status') }}</label>
                                                            <div class="col-sm-10">
                                                                <input class="form-check form-switch" name="footer[status]" type="checkbox"
