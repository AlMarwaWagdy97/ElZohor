...
@section('title', trans('admin.careers_categories_show' , ['name' => @$careerCategory->title]))
@section('title_page', trans('admin.careers_categories_show', ['name' => @$careerCategory->title]) )
                                                ...
                                                <div id="collapseOne{{ $key }}"
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        @foreach(config('translatable.locales') as $locale)
                                                            @php $trans = $careerCategory->trans()->where('locale',$locale)->first(); @endphp
                                                            @if($trans)
...
{{--                                                                <div class="row mb-3">--}}
{{--                                                                    <label for="example-text-input"--}}
{{--                                                                           class="col-sm-2 col-form-label">{{ trans('admin.description_in') . trans('lang.' .Locale::getDisplayName($locale)) }} </label>--}}
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text"
                                                                       ...
                                                                       value="{{ @$careerCategory->trans->where('locale',$locale)->first()->meta_title}}"
                                                                       id="title{{ $key }}">
                                                            </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea name="{{ $locale }}[meta_description]"
                                                                          ...
                                                                          disabled> {{ @$careerCategory->trans->where('locale',$locale)->first()->meta_description }} </textarea>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea name="{{ $locale }}[meta_key]"
                                                                          class="form-control description"
                                                                          disabled> {{ @$careerCategory->trans->where('locale',$locale)->first()->meta_key }} </textarea>
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    @if( @$careerCategory->image != null)
                                                        <div class="col-12">
                                                            <div class="row mb-3">
                                                                <div class="col-sm-12">
                                                                    <a href="{{ asset( @$careerCategory->image) }}"
                                                                       target="_blank">
                                                                        <img src="{{asset( @$careerCategory->image)}}" alt=""
                                                                             style="width:100%">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-12">
                                                        <div class="row mb-3">
                                                            <label for="example-number-input"
                                                                   col-form-label> @lang('articles.sort'):</label>
                                                            <div class="col-sm-12">
                                                            ...
                                                            <div class="col-sm-12">
                                                                <select disabled name="category_id"
                                                                    ...
                                                                    @forelse($categories as $category)
                                                                        <option
                                                                            {{( $careerCategory->category_id ==  old('category_id') || $careerCategory->category_id == $category->id)   ? 'selected' : ''}}   value="{{$category->id}}"> {{ optional($category->transNow)->title  }} </option>
                                                                    @empty
