...
@section('title_page', trans('clients.edit', ['name' => @$client->trans->where('locale',
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('admin.clients.update', $client->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div id="collapseOne{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne{{ $key }}" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="{{ $locale }}[title]" value="{{ @$client->trans->where('locale', $locale)->first()->title }}" id="title{{ $key }}">
                                                    ...
                                                    <div class="row mb-3 slug-section">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" id="slug{{ $key }}" name="{{ $locale }}[slug]" value="{{ @$client->trans->where('locale', $locale)->first()->slug }}" class="form-control slug mb-3" >
                                                ...
                                                <div id="collapseTwo{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingTwo{{ $key }}" data-bs-parent="#accordionExample">
                                                    <div class="accordion-body">
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input class="form-control" type="text" name="{{ $locale }}[meta_title]" value="{{ @$client->trans->where('locale', $locale)->first()->meta_title }}" id="title{{ $key }}">
                                                            </div>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea name="{{ $locale }}[meta_description]" class="form-control description"> {{ @$client->trans->where('locale', $locale)->first()->meta_description }} </textarea>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-10 mb-2">
                                                                <textarea name="{{ $locale }}[meta_key]" class="form-control description"> {{ @$client->trans->where('locale', $locale)->first()->meta_key }} </textarea>
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-12">
                                                            <input class="form-control" type="number" placeholder="@lang('admin.sort'):" id="example-number-input" name="sort" value="{{ @$client->sort }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                {{-- feature ------------------------------------------------------------------------------------- --}}
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="feature" type="checkbox" id="switch1" switch="success" {{ @$client->feature == 1 ? 'checked' : '' }} value="1">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <input class="form-check form-switch" name="status" type="checkbox" id="switch3" switch="success" {{ @$client->status == 1 ? 'checked' : '' }} value="1">
                            ...
                            <div class="row mb-3 text-end">
                                <div>
                                    <a href="{{ route('admin.clients.index') }}" class="btn btn-outline-danger waves-effect waves-light ml-3 btn-sm">@lang('button.cancel')</a>
