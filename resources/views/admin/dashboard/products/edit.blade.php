                                            ...
                                            <div id="collapseOne{{ $key }}" class="accordion-collapse collapse show mt-3" aria-labelledby="headingOne{{ $key }}" data-bs-parent="#accordionExample">
                                                <div class="accordion-body">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input class="form-control" type="text" name="{{ $locale }}[name]" value="{{ @$item->trans->where('locale', $locale)->first()->name }}" id="title{{ $key }}">
                                                        </div>
                                                    ...
                                                    <div class="row mb-3 slug-section">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" id="slug{{ $key }}" name="{{ $locale }}[slug]" value="{{ @$item->trans->where('locale', $locale)->first()->slug }}" class="form-control slug mb-3" required>
