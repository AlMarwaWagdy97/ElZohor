...
{{-- ------------------------------------------------------------------------------------------------------------------- --}}
<h4 class="page-title navbar-custom-color">@lang('admin.blogs')</h4>
<div class="col-md-6 col-xl-4">
    <div class="card">
        <div class="card-body">
            <a href="{{ route('admin.gallery.index') }}">
                <div class="mini-stat">
                    <span class="mini-stat-icon bg-teal me-0 float-end"> <i class="fas fa-pager"></i></span>
                    <div class="mini-stat-info">
                        <span class="counter text-teal">{{ App\Models\Gallery::count() }}</span>
        ...
        <div class="card-body">
            <a href="{{ route('admin.videos.index') }}">
                <div class="mini-stat">
                    <span class="mini-stat-icon bg-purple me-0 float-end"><i class="fa fa-sliders-h"></i></span>
                    <div class="mini-stat-info">
                        <span class="counter text-purple">{{ App\Models\Video::count() }}</span>
                            @lang('videos.videos') 
                    </div>
                </div>
            </a>
