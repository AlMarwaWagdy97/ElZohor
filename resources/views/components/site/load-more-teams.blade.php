...
@if($teams->count())
<div  id="loadMore">
    <a hx-get="{{ route('site.teams-more.loadMore', ['start' => ($start + $count), 'count' => $count]) }}" hx-indicator="#loading" hx-target="#loadMore" hx-swap="outerHTML" class="btn btn-more px-5 py-3 mx-auto mt-5">@lang('SEE MORE')</a>
</div>
@endif