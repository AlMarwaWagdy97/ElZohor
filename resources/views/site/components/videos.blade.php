    ...
    <div class="container">
        <div class="row">
            <div class="col-12 navigation text-lg-left text-center">
                <h1 class="text-secound"> {{translateTitle('our')}}  <span class="display-lg-3 w">  {{translateTitle('videos')}} </span></h1>
            </div>
                ...
                <div class=" col-12 col-lg-6 row  text-center ">
                    ...
                    @forelse ($videos as $video)
                        <div class="col-12 d-flex justify-content-center align-items-center">
                            <img src="{{ asset($video->image) }}" class="img-fluid" alt="" width="50%">
                            <p>
