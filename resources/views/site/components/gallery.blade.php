    ...
    <div class="container">
        <div class="row">
            <div class="col-12 navigation text-center text-lg-left">
                <h1 class="text-secound">    {{translateTitle('our')}}   <span class="display-lg-3 w">  {{translateTitle('gallery')}} </span></h1>
...
{{--                        </div>--}}
            ...
            <div class="col-12 justify-content-center text-center">
                <a href="{{ route('site.gallery.index') }}" class="btn text-white me-3 px-5 my-5">@lang('SEE ALL')    </a>
            </div>
        </div>
    </div>
</div>
