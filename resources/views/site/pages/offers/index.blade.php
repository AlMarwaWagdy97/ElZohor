...
{{--                    <div class="col-12 col-md-6 col-xl-4  mb-4 mb-md-5 wow animate__zoomIn animated  ">--}}
{{--                        <a href="{{ route('site.offers.show', @$offer->id) }}">--}}
{{--                        <div class="services__card img-fluid" style="background-image: url('{{ asset($offer->image) }}' )">--}}
{{--                            </div>--}}
{{--                        </a>--}}
{{--                        </div>--}}
                        ...
                        <div
                            class="col-12 col-md-4 mb-4 mb-md-5 wow animate__zoomIn animated"
                        >
                            <a href="{{ route('site.offers.show', @$offer->id) }}">
                    ...
                    <div class="col-12 justify-content-center text-center" id="loadMore">
                        <a hx-get="{{ route('site.offers-more.loadMore', ['start' => 6, 'count' => 6]) }}" hx-indicator="#loading" hx-target="#loadMore" hx-swap="outerHTML" class="btn text-white  bg-success me-3 px-5 my-5">@lang('SEE MORE')</a>
                    </div>
                </div>
